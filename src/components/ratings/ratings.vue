<template>
  <div class="ratings" ref="ratings">
    <div class="ratings-content">
      ...
      <split></split>
      <ratingselect v-bind:ratings="ratings" v-bind:select-type="selectType" v-bind:only-content="onlyContent" v-on:ratingTypeSelect="selectTypeChange" v-on:contentToggle="onlyContentChange" ></ratingselect>
      <div class="rating-wrapper">
        <ul>
          <li class="rating-item" v-for="rating in ratings" v-bind:key="rating.rateTime" v-show="needShow(rating.rateType,rating.text)">
            <div class="avatar">
            ...
            <div class="content">
              ...
              <div class="recommend" v-show="rating.recommend && rating.recommend.length">
                ...
                <span class="item" v-for="item in rating.recommend" v-bind:key="item">{{item}}</span>
              </div>
