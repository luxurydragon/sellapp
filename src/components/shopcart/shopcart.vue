  ...
  <div>
    <div class="shopcart">
      ...
      <div class="ball-container">
        <div v-for="ball in balls" v-bind:key="ball.num">
      ...
      <transition name="fold">
        <div class="shopcart-list" v-show="listShow">      
          ...
          <div class="list-content" ref="listContent">
            <ul>
              <li class="food" v-for="food in selectFoods" v-bind:key="food.name">
    ...
    <div class="listmask" v-show="listShow" v-on:click="hideList">
    ...
    methods: {
      ...
      beforeEnter(el) {
        ...
        while(count--) {
          ...
          if(ball.show) {
            let rect = ball.el.getBoundingClientRect(); // 获取元素相对于界面的位置
            let x = rect.left - 32;
  ...
  .shopcart
    ...
    .ball-container
      .ball
        ...
        bottom: 22px
        z-index: 99
        transition: all 0.4s cubic-bezier(0.49, -0.29, 0.75, 0.41) // 贝赛尔曲线
        .inner
          width: 16px
          height: 16px
          border-radius: 50%
